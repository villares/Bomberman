...
def draw():
    ...
    # if( p1.i >= 0 ):
    #     if (p1c[0]) :
    #         if (mapa[p1.i][p1.j-1] == 0 and nao_ha_bombas(p1.i, p1.j-1) and !p2.equals(p1.i, p1.j-1)) p1.j--
    #     #
    #     if (p1c[1]) :
    #         if (mapa[p1.i][p1.j+1] == 0 and nao_ha_bombas(p1.i, p1.j+1) and !p2.equals(p1.i, p1.j+1)) p1.j++
    #     #
    #     if (p1c[2]) :
    #         if (mapa[p1.i-1][p1.j] == 0 and nao_ha_bombas(p1.i-1, p1.j) and !p2.equals(p1.i-1, p1.j)) p1.i--
    #     #
    #     if (p1c[3]) :
    #         if (mapa[p1.i+1][p1.j] == 0 and nao_ha_bombas(p1.i+1, p1.j) and !p2.equals(p1.i+1, p1.j)) p1.i++
    #     #
    # if( p1c[4] and nao_ha_bombas(p1.i, p1.j) ) bombs.add( #Bomb( p1 ) )
    # #
        
    # EFETUANDO OS CONTROLES DO PLAYER 2
    # if( p2.i >= 0 ):
    #     if (p2c[0]) :
    #         if (mapa[p2.i][p2.j-1] == 0 and nao_ha_bombas(p2.i, p2.j-1) and !p1.equals(p2.i, p2.j-1)) p2.j--
    #     #
    #     if (p2c[1]) :
    #         if (mapa[p2.i][p2.j+1] == 0 and nao_ha_bombas(p2.i, p2.j+1) and !p1.equals(p2.i, p2.j+1)) p2.j++
    #     #
    #     if (p2c[2]) :
    #         if (mapa[p2.i-1][p2.j] == 0 and nao_ha_bombas(p2.i-1, p2.j) and !p1.equals(p2.i-1, p2.j)) p2.i--
    #     #
    #     if (p2c[3]) :
    #         if (mapa[p2.i+1][p2.j] == 0 and nao_ha_bombas(p2.i+1, p2.j) and !p1.equals(p2.i+1, p2.j)) p2.i++
    #     #
    # if( p2c[4] and nao_ha_bombas(p2.i, p2.j) ) bombs.add( #Bomb( p2 ) )
    # #
    ...
    for b in bombs:
        ...
        if b.explodiu():
            ...
            # para cima
            # for(    e = b.pos.j - 1 e >= b.pos.j - b.alcance --e ):
                if mapa[b.pos.i][e] == 2:
                    break
            ...
            # for(    e = b.pos.j + 1 e <= b.pos.j + b.alcance ++e ):
                ...
                if mapa[b.pos.i][e] == 1:
                    ...
                    continue
                #
                if p1.equals(b.pos.i, e): p1.set(-1, -1)
                if p2.equals(b.pos.i, e): p2.set(-1, -1)
                kaboom((b.pos.i + 0.5) * l, (e + 0.5) * l)
            # para a esquerda
            # for(    e = b.pos.i - 1 e >= b.pos.i - b.alcance --e ):
                if mapa[e][b.pos.j] == 2: break
                if mapa[e][b.pos.j] == 1:
                    mapa[e][b.pos.j] = 0
                    continue
                if p1.equals(e, b.pos.j): p1.set(-1, -1)
                if p2.equals(e, b.pos.j): p2.set(-1, -1)
            ...
            # for(    e = b.pos.i + 1 e <= b.pos.i + b.alcance ++e ):
                ...
                kaboom((e + 0.5) * l, (b.pos.j + 0.5) * l)
            #
        b.del #indentar no for


def nao_ha_bombas(I, J):
    for b in bombs:
        if b.pos.equals(I, J): return False
    return True
#
